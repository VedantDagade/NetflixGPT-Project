...
const Login = () => {
  ...
  return (
    <div className="relative min-h-screen text-white">
      ...
      <form className="absolute w-3/12 max-w-md p-10 bg-black opacity-85 rounded-lg top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-lg">
        ...
        <input
          ...
          className="p-4 mb-6 w-full bg-gray-900 text-white border border-gray-600 rounded"
        />
        ...
        <p
          className="py-2 hover:font-bold cursor-pointer"
